...
def process_bounding_octagon_corner_strings(dataset):
    ...
    bottom_right_corner, right_bottom_corner = \
        process_octagon_local_corners(dataset.stops, min_lat_float, max_lon_float, OCTAGON_LOWER_RIGHT_CORNER_MAP)
    ...
    bottom_left_corner, left_bottom_corner = \
        process_octagon_local_corners(dataset.stops, min_lat_float, min_lon_float, OCTAGON_LOWER_LEFT_CORNER_MAP)
    ...
    top_left_corner, left_top_corner = \
        process_octagon_local_corners(dataset.stops, max_lat_float, min_lon_float, OCTAGON_UPPER_LEFT_CORNER_MAP)
    ...
    top_right_corner, right_top_corner = \
        process_octagon_local_corners(dataset.stops, max_lat_float, max_lon_float, OCTAGON_UPPER_RIGHT_CORNER_MAP)
...
def process_geographical_coordinates_as_string(dataset_stops):
    ...
    max_lat_string = convert_coordinate_to_degrees_and_minutes_string(Latitude, max_lat_float)
    min_lat_string = convert_coordinate_to_degrees_and_minutes_string(Latitude, min_lat_float)
    max_lon_string = convert_coordinate_to_degrees_and_minutes_string(Longitude, max_lon_float)
    min_lon_string = convert_coordinate_to_degrees_and_minutes_string(Longitude, min_lon_float)
...
def process_octagon_local_corners(dataset_stops, lat_float, lon_float, octagon_corner_map):
...
def convert_octagon_section_corners_coordinates_to_corner_strings(corner_1_lat_float, corner_1_lon_float,
    ...
    # Convert the corners coordinates to strings
    corner_1_lat_string = convert_coordinate_to_degrees_and_minutes_string(Latitude, corner_1_lat_float)
    corner_1_lon_string = convert_coordinate_to_degrees_and_minutes_string(Longitude, corner_1_lon_float)

    corner_2_lat_string = convert_coordinate_to_degrees_and_minutes_string(Latitude, corner_2_lat_float)
    corner_2_lon_string = convert_coordinate_to_degrees_and_minutes_string(Longitude, corner_2_lon_float)
...
def convert_coordinate_to_degrees_and_minutes_string(coordinate_class, coordinate_float):
