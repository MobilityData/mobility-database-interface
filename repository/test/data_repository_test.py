...
class DataRepositoryTest(TestCase):
    ...
    @mock.patch('representation.gtfs_representation.GtfsRepresentation')
    def test_data_repository_adding_representation_with_valid_parameters_should_return_none(self, mock_representation):
        mock_representation.__class__ = GtfsRepresentation
        mock_dataset_key = MagicMock()
        mock_dataset_key.__class__ = str
        under_test = DataRepository().add_dataset_representation(mock_dataset_key, mock_representation)
        self.assertIsNone(under_test)

    @mock.patch('representation.gtfs_representation.GtfsRepresentation')
    def test_data_repository_print_dataset_representations_should_return_none(self, mock_representation):
        mock_representation.__class__ = GtfsRepresentation
        mock_dataset_key = MagicMock()
        mock_dataset_key.__class__ = str
    ...
    @mock.patch('representation.gtfs_representation.GtfsRepresentation')
    def test_data_repository_print_dataset_representation_with_non_existent_key_should_return_none(self,
                                                                                                   mock_representation):
        mock_representation.__class__ = GtfsRepresentation
        mock_dataset_key = MagicMock()
        mock_dataset_key.__class__ = str
        ...
        data_repository.add_dataset_representation(str(mock_dataset_key), mock_representation)
        under_test = data_repository.print_dataset_representation(test_dataset_key)
        self.assertIsNone(under_test)

    @mock.patch('representation.gtfs_representation.GtfsRepresentation')
    def test_data_repository_print_dataset_representation_with_existent_key_should_return_none(self,
                                                                                               mock_representation):
        mock_representation.__class__ = GtfsRepresentation
        mock_dataset_key = MagicMock()
        mock_dataset_key.__class__ = str
    ...
    @mock.patch('representation.gtfs_representation.GtfsRepresentation')
    def test_data_repository_get_dataset_representations_should_return_representations(self, mock_representation):
        mock_representation.__class__ = GtfsRepresentation
        mock_dataset_key = MagicMock()
        mock_dataset_key.__class__ = str
        mock_dataset_key.__str__.return_value = 'test_key'
    ...
    @mock.patch('representation.gtfs_representation.GtfsRepresentation')
    def test_data_repository_get_dataset_representation_with_non_existent_key_should_return_none(self,
                                                                                                 mock_representation):
        mock_representation.__class__ = GtfsRepresentation
        mock_dataset_key = MagicMock()
        mock_dataset_key.__class__ = str
    ...
    @mock.patch('representation.gtfs_representation.GtfsRepresentation')
    def test_data_repository_get_dataset_representation_with_existent_key_should_return_none(self, mock_representation):
        mock_representation.__class__ = GtfsRepresentation
        mock_dataset_key = MagicMock()
        mock_dataset_key.__class__ = str
        mock_dataset_key.__str__.return_value = 'test_key'
