...
from usecase.process_all_timezones_for_gtfs_metadata import process_all_timezones_for_gtfs_metadata
...
class TestProcessMainTimezoneForGtfsMetadata(TestCase):
    ...
    def test_process_all_timezones_with_invalid_gtfs_representation_should_raise_exception(self):
        ...
        self.assertRaises(TypeError, process_all_timezones_for_gtfs_metadata, mock_gtfs_representation)
