...
class ExtractSourcesUrlTest(TestCase):
    ...
    def test_extract_sources_url_with_none_api_request_manager_should_raise_exception(
        self, mock_sparql_request_manager
    ):
        mock_sparql_request_manager.__class__ = SparqlRequestManager
        self.assertRaises(
            TypeError, ExtractSourcesUrl, None, mock_sparql_request_manager
        )

    @mock.patch("request_manager.sparql_request_manager.SparqlRequestManager")
    def test_extract_sources_url_with_invalid_api_request_manager_should_raise_exception(
        self, mock_sparql_request_manager
    ):
        mock_sparql_request_manager.__class__ = SparqlRequestManager
        self.assertRaises(
    ...
    def test_extract_sources_url_with_none_sparql_request_manager_should_raise_exception(
    ...
    @mock.patch("request_manager.api_request_manager.ApiRequestManager")
    def test_extract_sources_url_with_invalid_sparql_request_manager_should_raise_exception(
        self, mock_api_request_manager
    ):
        mock_api_request_manager.__class__ = ApiRequestManager
        self.assertRaises(
    ...
    @mock.patch("request_manager.api_request_manager.ApiRequestManager")
    @mock.patch("request_manager.sparql_request_manager.SparqlRequestManager")
    def test_extract_sources_url_with_valid_request_managers_should_not_raise_exception(
        self, mock_api_request_manager, mock_sparql_request_manager
    ):
        mock_api_request_manager.__class__ = ApiRequestManager
        mock_sparql_request_manager.__class__ = SparqlRequestManager
        under_test = ExtractSourcesUrl(
    ...
    def test_extract_sources_url_with_default_parameters_should_return_urls_dictionary(
        ...
        self.assertEqual(
            under_test.execute(),
            {"Q82": "http://www.stl.laval.qc.ca/opendata/GTF_STL.zip"},
        )
    ...
    @mock.patch("request_manager.api_request_manager.ApiRequestManager")
    @mock.patch("request_manager.sparql_request_manager.SparqlRequestManager")
    def test_extract_sources_url_with_GTFS_dataset_type_should_return_urls_dictionary(
        self, mock_api_request_manager, mock_sparql_request_manager
    ):
        mock_api_request_manager.__class__ = ApiRequestManager
        mock_api_request_manager.execute_get.return_value = {
        ...
        under_test = ExtractSourcesUrl(
            mock_api_request_manager, mock_sparql_request_manager, dataset_type="GTFS"
        )
        self.assertEqual(
            under_test.execute(),
            {"Q82": "http://www.stl.laval.qc.ca/opendata/GTF_STL.zip"},
    ...
    @mock.patch("request_manager.api_request_manager.ApiRequestManager")
    @mock.patch("request_manager.sparql_request_manager.SparqlRequestManager")
    def test_extract_sources_url_with_GBFS_dataset_type_should_return_urls_dictionary(
        self, mock_api_request_manager, mock_sparql_request_manager
    ):
        mock_api_request_manager.__class__ = ApiRequestManager
        mock_api_request_manager.execute_get.return_value = {
        ...
        under_test = ExtractSourcesUrl(
            mock_api_request_manager, mock_sparql_request_manager, dataset_type="GBFS"
        )
        self.assertEqual(
            under_test.execute(),
            {"Q82": "http://www.stl.laval.qc.ca/opendata/GTF_STL.zip"},
    ...
    @mock.patch("request_manager.api_request_manager.ApiRequestManager")
    @mock.patch("request_manager.sparql_request_manager.SparqlRequestManager")
    def test_extract_sources_url_with_non_existing_specific_dataset_should_return_no_url(
        self, mock_api_request_manager, mock_sparql_request_manager
    ):
        mock_api_request_manager.__class__ = ApiRequestManager
        mock_api_request_manager.execute_get.return_value = {
    ...
    @mock.patch("request_manager.api_request_manager.ApiRequestManager")
    @mock.patch("request_manager.sparql_request_manager.SparqlRequestManager")
    def test_extract_sources_url_with_existing_specific_dataset_should_return_url(
        self, mock_api_request_manager, mock_sparql_request_manager
    ):
        mock_api_request_manager.__class__ = ApiRequestManager
        mock_api_request_manager.execute_get.return_value = {
