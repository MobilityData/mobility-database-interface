...
class ExtractDatabaseMd5Test(TestCase):
    ...
    def test_extract_database_md5_with_none_api_request_manager_should_raise_exception(
    ...
    @mock.patch("request_manager.sparql_request_manager.SparqlRequestManager")
    def test_extract_database_md5_with_invalid_api_request_manager_should_raise_exception(
        self, mock_sparql_request_manager
    ):
        mock_sparql_request_manager.__class__ = SparqlRequestManager
        mock_entity_codes = MagicMock()
    ...
    def test_extract_database_md5_with_none_sparql_request_manager_should_raise_exception(
    ...
    @mock.patch("request_manager.api_request_manager.ApiRequestManager")
    def test_extract_database_md5_with_invalid_sparql_request_manager_should_raise_exception(
        self, mock_api_request_manager
    ):
        mock_api_request_manager.__class__ = ApiRequestManager
        mock_entity_codes = MagicMock()
    ...
    @mock.patch("request_manager.api_request_manager.ApiRequestManager")
    @mock.patch("request_manager.sparql_request_manager.SparqlRequestManager")
    def test_extract_database_md5_with_none_entity_codes_should_raise_exception(
    ...
    @mock.patch("request_manager.api_request_manager.ApiRequestManager")
    @mock.patch("request_manager.sparql_request_manager.SparqlRequestManager")
    def test_extract_database_md5_with_invalid_entity_codes_should_raise_exception(
        self, mock_api_request_manager, mock_sparql_request_manager
    ):
        mock_api_request_manager.__class__ = ApiRequestManager
        mock_sparql_request_manager.__class__ = SparqlRequestManager
    ...
    @mock.patch("request_manager.api_request_manager.ApiRequestManager")
    @mock.patch("request_manager.sparql_request_manager.SparqlRequestManager")
    def test_extract_database_md5_with_valid_parameters_should_not_raise_exception(
        self, mock_api_request_manager, mock_sparql_request_manager
    ):
        mock_api_request_manager.__class__ = ApiRequestManager
        mock_sparql_request_manager.__class__ = SparqlRequestManager
        ...
        under_test = ExtractDatabaseMd5(
            mock_api_request_manager, mock_sparql_request_manager, mock_entity_codes
        )
    ...
    @mock.patch("request_manager.api_request_manager.ApiRequestManager")
    @mock.patch("request_manager.sparql_request_manager.SparqlRequestManager")
    def test_extract_database_md5_with_empty_entity_codes_should_return_empty_md5_dict(
        self, mock_api_request_manager, mock_sparql_request_manager
    ):
        test_entities = []
        test_md5 = {}
    ...
    def test_extract_database_md5_with_existing_entity_codes_should_return_md5_dict(
        ...
        mock_api_request_manager.execute_get.return_value = {
            "entities": {
                "Q81": {
                    "claims": {
                        "P61": [{"mainsnak": {"datavalue": {"value": "md5_hash"}}}]
                    }
                }
            }
        }
