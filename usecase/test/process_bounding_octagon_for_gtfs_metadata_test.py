...
class ProcessBoundingOctagonForGtfsMetadataTest(TestCase):
    ...
    def test_process_bounding_octagon_execution_should_set_bounding_box_metadata(self, mock_gtfs_representation,
        ...
        mock_gtfs_representation.set_metadata_bounding_octagon.assert_called_with({'1': '1°0\'0.000"S, 3°0\'0.000"E',
