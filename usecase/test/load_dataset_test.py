...
class LoadDatasetTest(TestCase):
    ...
    def test_load_dataset_with_none_data_repository_should_raise_exception(self, mock_factory):
        ...
        mock_datasets_infos.__class__ = dict
        mock_datatype = MagicMock()
        mock_datatype.__class__ = str
        mock_datatype.__str__.return_value = 'GTFS'
        self.assertRaises(TypeError, LoadDataset, None, mock_factory, mock_datasets_infos, str(mock_datatype))
    ...
    def test_load_dataset_with_invalid_data_repository_should_raise_exception(self, mock_factory):
        ...
        mock_datatype.__class__ = str
        mock_datatype.__str__.return_value = 'GTFS'
        self.assertRaises(TypeError, LoadDataset, mock_factory, mock_factory, mock_datasets_infos, str(mock_datatype))
    ...
    def test_load_dataset_with_none_representation_factory_should_raise_exception(self, mock_data_repository):
        ...
        mock_datatype.__class__ = str
        mock_datatype.__str__.return_value = 'GTFS'
        self.assertRaises(TypeError, LoadDataset, mock_data_repository, None, mock_datasets_infos, str(mock_datatype))
    ...
    def test_load_dataset_with_invalid_datasets_infos_should_raise_exception(self, mock_data_repository, mock_factory):
        ...
        mock_datatype.__class__ = str
        mock_datatype.__str__.return_value = 'GTFS'
        self.assertRaises(TypeError, LoadDataset, mock_data_repository, mock_factory, mock_factory, str(mock_datatype))
    ...
    def test_load_dataset_with_none_dataset_type_should_raise_exception(self, mock_data_repository, mock_factory):
        ...
        mock_datasets_infos = MagicMock()
        mock_datasets_infos.__class__ = dict
        self.assertRaises(TypeError, LoadDataset, mock_data_repository, mock_factory, mock_datasets_infos, None)
    ...
    def test_load_dataset_with_empty_datasets_should_add_nothing_to_data_repo(self, mock_data_repository, mock_factory):
        ...
        mock_datasets_infos = MagicMock()
        mock_datasets_infos.__class__ = dict
        mock_datasets_infos.__getitem__.side_effect = test_datasets_infos.__getitem__
        mock_datasets_infos.items.return_value = test_datasets_infos.items()

        mock_datatype = MagicMock()
        mock_datatype.__class__ = str
        mock_datatype.__str__.return_value = 'GTFS'

        under_test = LoadDataset(mock_data_repository, mock_factory, mock_datasets_infos, str(mock_datatype)).execute()
    ...
    def test_load_dataset_with_datasets_should_add_representation_to_data_repo(self, mock_data_repository,
        ...
        test_datasets = {
            'Q80': {
                ...
                'download_date': 'test_download_date'}
        }
