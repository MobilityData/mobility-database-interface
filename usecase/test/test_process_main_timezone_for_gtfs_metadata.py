...
class ProcessMainTimezoneForGtfsMetadataTest(TestCase):
    ...
    def test_process_main_timezone_with_invalid_gtfs_repr(self):
        ...
        self.assertRaises(TypeError, process_main_timezone_for_gtfs_metadata, mock_gtfs_representation)

    @mock.patch('representation.gtfs_representation.GtfsRepresentation')
    def test_process_main_timezone_with_valid_gtfs_representation(self,
    ...
    def test_process_main_timezone(self,
                                   mock_gtfs_representation,
                                   mock_dataset,
                                   mock_metadata):
