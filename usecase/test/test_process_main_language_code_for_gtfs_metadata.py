...
class TestProcessMainLanguageCodeForGtfsMetadata(TestCase):
    ...
    def test_process_main_language_code_with_invalid_gtfs_repr(self):
        ...
        self.assertRaises(TypeError, process_main_language_code_for_gtfs_metadata, mock_gtfs_representation)
    ...
    def test_process_main_language_code_with_valid_gtfs_representation_should_return_instance(self,
        ...
        under_test = process_main_language_code_for_gtfs_metadata(mock_gtfs_representation)
