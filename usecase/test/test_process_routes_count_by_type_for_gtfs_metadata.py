...
class TestProcessRoutesCountByTypeForGtfsMetadata(TestCase):
    ...
    def test_process_routes_count_with_invalid_gtfs_representation_should_raise_exception(self):
        ...
        self.assertRaises(TypeError, process_routes_count_by_type_for_gtfs_metadata, mock_gtfs_representation)
    ...
    def test_process_routes_count_with_valid_gtfs_representation_should_return_instance(self, mock_gtfs_representation):
        ...
        under_test = process_routes_count_by_type_for_gtfs_metadata(mock_gtfs_representation)
