...
class SparqlRequestManagerTest(TestCase):
    def test_sparql_request_manager_initialized_with_none_sparql_client_should_raise_exception(
        self,
    ):
        self.assertRaises(TypeError, SparqlRequestManager, None)

    @mock.patch("request_manager.sparql_client.SparqlClient")
    def test_sparql_request_manager_initialized_with_sparql_client_should_not_raise_exception(
        self, mock_sparql_client
    ):
    ...
    @mock.patch("request_manager.sparql_client.SparqlClient")
    def test_sparql_get_request_with_none_query_should_return_none(
        self, mock_sparql_client
    ):
        query = None
    ...
    @mock.patch("request_manager.sparql_client.SparqlClient")
    def test_sparql_get_request_with_none_service_should_raise_exception(
        self, mock_sparql_client
    ):
        query = """
                SELECT *
    ...
    def test_sparql_get_request_with_query_and_session_should_return_response(
        self, mock_sparql_client, mock_service, mock_response
    ):
        query = """
                SELECT *
                WHERE 
